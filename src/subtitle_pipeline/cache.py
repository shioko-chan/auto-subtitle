...
STAGES = {
    ...
    "asr_correction": StageDefinition(2, ("raw_speech", "conditioned_asr")),
    ...
    "segmentation": StageDefinition(1, ("source_cues",)),
    "lyrics_translation": StageDefinition(1, ("song_identification",)),
    "translation": StageDefinition(1, ("segmentation", "lyrics_translation")),
